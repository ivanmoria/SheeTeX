...
# =============================================================================
# INTERFACE PRINCIPAL (Layout 60/40 + Pesquisa + Dark Fix)
# =============================================================================
class BiblioApp(QMainWindow):
    ...
    def initUI(self):
        ...
        # ABA 1: SPLITTER (LOG + PDF) - ATUALIZADO 60/40
        ...
        # --- DARK FIX: Fundo preto e HTML vazio para evitar flash branco ---
        ...
        # SETTINGS CRÍTICOS PARA O PDF CARREGAR CORRETAMENTE
        ...
        # ATALHO CTRL+F PARA PESQUISA NO PDF
        self.shortcut_find = QShortcut(QKeySequence("Ctrl+F"), self)
        self.shortcut_find.activated.connect(self.trigger_pdf_search)

        # OUTRAS ABAS
        self.table = QTableWidget(0, 8)
        self.table.setHorizontalHeaderLabels(["AUTORES", "TÍTULO", "ANO", "LINK DOI", "JORNAL", "PUBLISHER", "TIPO", "ABSTRACT"])
        self.table.horizontalHeader().setSectionResizeMode(QHeaderView.Interactive)
        self.table.horizontalHeader().resizeSection(1, 300); self.table.horizontalHeader().resizeSection(7, 400)
